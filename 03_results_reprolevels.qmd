...
(plot1A + plot2A + plot3A) / (plot1B + plot2B + plot3B) + 
  ...
  plot_annotation(
    ...
    subtitle = stringr::str_glue("Top: pre-guidelines (2026, 2018) papers (N={n_papers_giscience_pre}). Bottom: post-guidelines (2021 Part II, 2023) papers (N={n_papers_giscience_post}).\n X-axis labels: (U)ndocumented; (D)ocumented; Documented and (A)vailable; Documented, Available and (O)pen."),
