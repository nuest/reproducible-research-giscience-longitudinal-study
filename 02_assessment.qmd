...
What we observe in @tbl-disagr-uncertain-conf: 
...
In @fig-disagr-uncertain-heatmap, we look now at the individual scores (UDAO naming scheme) for each of the dimensions (data, methods, results). 

```{r}
#| label: fig-disagr-uncertain-heatmap
#| fig-cap: "AGILE only: Counts of disagraments (UDAI level) between reviewers (heatmap)"
#| fig-subcap: 
#|     - "Data"
#|     - "Methods"
#|     - "Results"
...
heatmap_dat |>
  ...
  ggplot2::coord_fixed() +
  ggplot2::labs(title = "Data disagreement",
       x = "Reviewer 1",
       y = "Reviewer 2") +
  ggplot2::theme_minimal()
...
heatmap_met |>
  ...
  ggplot2::scale_fill_gradient(low = "blue", high = "red") + 
  ggplot2::coord_fixed() +
  ggplot2::labs(title = "Methods disagreement",
       x = "Reviewer 1",
       y = "Reviewer 2") +
  ggplot2::theme_minimal()
...
heatmap_res |>
  ...
  ggplot2::scale_fill_gradient(low = "blue", high = "red") + 
  ggplot2::coord_fixed() +
  ggplot2::labs(title = "Results disagreement",
       x = "Reviewer 1",
       y = "Reviewer 2") +
  ggplot2::theme_minimal()
