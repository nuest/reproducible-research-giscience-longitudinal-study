...
plot1A <- criteriaBarplot(papers_giscience_pre, col = consolidated_data, main = "Data", colour = colours[1])

plot2A <- criteriaBarplot(papers_giscience_pre, col = consolidated_methods, main = "Methods", colour = colours[2])
...
plot1B <- criteriaBarplot(papers_giscience_post, col = consolidated_data, main = "Data", colour = colours[1])

plot2B <- criteriaBarplot(papers_giscience_post, col = consolidated_methods, main = "Methods", colour = colours[2])
...
(plot1A + plot2A + plot3A) / (plot1B + plot2B + plot3B) + 
  ...
  plot_annotation(
    title = "GIScience paper assessment according to the dimensions Data, Methods and Results.",
    subtitle = stringr::str_glue("Top: N={n_papers_giscience_pre}. 2016 and 2018 papers; Bottom: N={n_papers_giscience_post}. 2021 and 2023 papers."),
    caption = "Note: GIScience 2021 proceedings have two volumes. Volume I includes papers published in 2020.", 
    tag_levels = 'A') & 
  theme(plot.tag = element_text(size = 8))
