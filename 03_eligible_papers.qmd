...
criteriaBarplot2 = function(df, col, main, colour) {
  ...
  ggplot2::ggplot(df,
    ...
    ggplot2::geom_text(
      # Mapeamos la etiqueta al texto que queremos mostrar (el porcentaje)
      aes(label = scales::label_percent(accuracy = 0.1)(p)),
      # Ajustamos la posición vertical para que esté por encima de la barra
      vjust = -0.5,
      size = 3.5,
      color = "black"
    ) +
...
plot1A <- criteriaBarplot2(papers_giscience_data_pre, col = consolidated_data, main = "Input data", colour = colours[1])
...
plot1B <- criteriaBarplot2(papers_giscience_data_post, col = consolidated_data, main = "Input data", colour = colours[1])
...
plotA <- criteriaBarplot2(papers_agile_data_pre, col = consolidated_data, main = "Input data", colour = colours[1])
...
plotD <- criteriaBarplot2(papers_agile_data_post, col = consolidated_data, main = "Input data", colour = colours[1])
