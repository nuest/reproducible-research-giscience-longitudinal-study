...
title: "02_methods"
description: |
    Supporting notebook for calculating basic statistics related to the papers corpus. See the "Methods" section in the final articel
...
@tbl-batches below corresponds to the **Table 2: Conference series grouped into batches for A2’s assessment** of the published paper.
