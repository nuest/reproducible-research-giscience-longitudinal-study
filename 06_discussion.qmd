...
papers_agile_post |>
  ...
  dplyr::tally() |>
  dplyr::mutate(proportion = round(n / sum(n) * 100, digits = 1)) |>
  gt::gt()
```
...
ggplot2::ggplot(papers_agile_post_sankey, 
                ...
                aes(axis1 = agg_level, axis2 = year, y = n)) +
  #ggplot2::scale_x_discrete(limits = c("Aggregate level", "Year", "Badge"), expand = c(.1, .05)) +
  ggplot2::scale_x_discrete(limits = c("Aggregate level", "Year"), expand = c(.1, .05)) +
  #ggplot2::scale_fill_brewer(type = "qual", palette = "Dark2") +
  # Manual color selection
  ggplot2::scale_fill_manual(values = c("TRUE" = "#E6AD12", "FALSE" = "#4B0082")) + 
  ...
  ggplot2::labs(
    ...
    subtitle = stringr::str_glue("AGILE post-intervention papers: {n_papers_agile_post_with_badge} with badge, {n_papers_agile_post_wo_badge} without badge"),
    x = "",
    y = "Number of papers", 
